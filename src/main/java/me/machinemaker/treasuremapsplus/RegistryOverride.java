...
public record RegistryOverride<T>(ResourceKey<? extends Registry<T>> registryKey, ResourceKey<T> resourceKey, T value) {
    ...
    static {
        try {
            ...
            TO_ID_MAP = mappedRegistryLookup.findGetter(MappedRegistry.class, "toId", Reference2IntMap.class);
            BY_VALUE_MAP = mappedRegistryLookup.findGetter(MappedRegistry.class, "byValue", Map.class);
            ...
            SET_HOLDER_VALUE = referenceHolderLookup.findSetter(Holder.Reference.class, "value", Object.class);
