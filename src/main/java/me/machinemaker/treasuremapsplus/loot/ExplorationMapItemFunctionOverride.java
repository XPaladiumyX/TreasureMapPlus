...
public class ExplorationMapItemFunctionOverride {
    ...
    @VisibleForTesting
    static final ResourceKey<MapCodec<? extends LootItemFunction>> EXPLORATION_FUNCTION_KEY = ResourceKey.create(Registries.LOOT_FUNCTION_TYPE, Identifier.parse("exploration_map"));
    ...
    @VisibleForTesting
    final RegistryOverride<MapCodec<? extends LootItemFunction>> registryOverride;
    ...
    ExplorationMapItemFunctionOverride(final RegistryAccess registryAccess, final List<Component> lore, final boolean replaceChests) {
        ...
        final MapCodec<ExplorationMapFunction> mapCodecCodec = ExplorationMapFunction.MAP_CODEC;
